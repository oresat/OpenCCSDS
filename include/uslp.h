...
typedef struct {
    ...
    sdu_recv_t      map_recv;       /** MAP Service Receive                      */
...
typedef struct {
    ...
    sdu_recv_t      mc_ocf_recv;    /** Master Channel OCF Service Receive       */
    sdu_recv_t      vcf_recv;       /** Virtual Channel Frame Service Receive    */
...
typedef struct {
    ...
    pdu_send_t      phy_send;       /** Function to send a frame                 */
